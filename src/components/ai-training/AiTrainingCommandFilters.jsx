...
export default function AiTrainingCommandFilters() {
  return (
    <div style={{ 
      display: 'flex', 
      flexWrap: 'wrap', 
      ...
      <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'center' }}>
        <div style={{ position: 'relative' }}>
          ...
          <input type="text" placeholder="Search Model or Dataset..." style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', padding: '8px 12px 8px 32px', borderRadius: '4px', color: '#fff', fontSize: '12px', outline: 'none', width: '200px' }} />
        </div>
        <CustomSelect options={['All Statuses', 'DEPLOYED', 'CANDIDATE', 'FAILED', 'ARCHIVED']} defaultValue="All Statuses" />
        <CustomSelect options={['All Datasets', 'Global_Telemetry_Q1', 'Nevada_Thermal_Fix']} defaultValue="All Datasets" />
      </div>
